          ...
          switch(choice)
          {
			  ...
			  lastN = scan.nextLine();
                                  ...
                                  boolean found = false;
			  		 			  ...
			  		 			  {
			  		 				  // changed the manner in which first and last are accessed to ensure info hiding
			  		 				if( per.personList.get(i).getFName().equals(firstN) && per.personList.get(i).getLName().equals(lastN))
			  		 				{
			  		 				found = true;
			  		 			    loc = i;
			  		 			    }
