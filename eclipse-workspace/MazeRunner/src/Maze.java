...
public class Maze
{
   ...
   private int numberRows, numberColumns, depthCount;
   private int[][][] grid;
   ...
   public Maze(String filename) throws FileNotFoundException
   {
      ...
      depthCount = scan.nextInt();
      
      grid = new int[numberRows][numberColumns][depthCount];
      for (int z = 0; z < depthCount; z++)
      	for (int i = 0; i < numberRows; i++)
      		for (int j = 0; j < numberColumns; j++)
      			grid[i][j][z] = scan.nextInt();
   }
    ...
    * @param dep the index of the column to try
    */
   public void tryPosition(int row, int col, int dep)
   {
      grid[row][col][dep] = TRIED;
   }
   ...
   /**
    * Returns the depth of the array or the z axis
    * @return the depth
    */
   public int getDepth()
   {
    ...
    * @param dep the index of the depth to mark as part of the PATH
    */
   public void markPath(int row, int col, int dep)
   {
      grid[row][col][dep] = PATH;
   }
    ...
    * @param dep the depth to be checked
    * @return true if the location is valid    
    */
   public boolean validPosition(int row, int column, int dep)
   {
      ...
      if (row >= 0 && row < grid.length &&
         ...
         dep >= 0 && dep < grid[row][column].length)
