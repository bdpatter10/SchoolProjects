...
public class Assignment2 {
	...
	public static void main(String[] args)
	{
		...
		// CHANGED!! in order to make validate take an input for testing.
		 long cardNumber=0;
	...
	public static String Validate(long cardNum)
	{
		 ...
		 int[] digitArray = new int[CARD_LENGHT];
				 ...
				 // Fixed the second digit is the 1 index in the array
				 ...
				 for(i= CARD_LENGHT - 2;  i >= 0; i= i-2)
				 {
					 ...
					 // num needs to be divided into its individual digits. ie. 5 *2 = 10 = num 
					 // sum2 = sum + digit[0] of num ie. 1 + digit[1] of num ie. 0 
					 if(num >= 10) {
						 int num1 = num % 10;
						 int num2 = num / 10;
						 sum2 =  sum2 + num1 + num2;
